  ...
  <section class="content">
    ...
    <div class="container-fluid">
      ...
      <style>
        ...
        .blotter-timeline .tl-step.done .tl-dot  { background: #28a745; color: #fff; box-shadow: 0 0 0 2px #28a745; }

        .blotter-timeline .tl-step.done .tl-label { color: #28a745; }

        .blotter-timeline .tl-step.active .tl-dot  { background: #007bff; color: #fff; box-shadow: 0 0 0 3px #007bff55; }

        .blotter-timeline .tl-step.active .tl-label { color: #007bff; font-size: 11px; }
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h5 class="modal-title"><i class="fas fa-folder-open fa-fw"></i> Blotter Record — <span id="viewModalCaseNo"></span></h5>
      ...
      <div class="modal-body">
        ...
        <div class="blotter-timeline" id="blotterTimeline">

          <div class="tl-progress" id="tlProgress" style="width:0;"></div>

          <div class="tl-step" data-step="Ongoing">

            <div class="tl-dot"><i class="fas fa-circle-notch"></i></div>

            <div class="tl-label">Ongoing</div>

          </div>

          <div class="tl-step" data-step="Investigation">

            <div class="tl-dot"><i class="fas fa-search"></i></div>

            <div class="tl-label">Investigation</div>

          </div>

          <div class="tl-step" data-step="Mediation">

            <div class="tl-dot"><i class="fas fa-handshake"></i></div>

            <div class="tl-label">Mediation</div>

          </div>

          <div class="tl-step" data-step="Settled">

            <div class="tl-dot"><i class="fas fa-check"></i></div>

            <div class="tl-label">Settled</div>

          </div>

          <div class="tl-step" data-step="Closed">
        ...
        <table class="table table-sm table-borderless detail-panel mb-3">
          ...
          <tbody>
            ...
            <tr><th>Case #</th><td id="vCaseNumber">—</td></tr>

            <tr><th>Accusation</th><td id="vIncidentType">—</td></tr>

            <tr><th>Complainant</th><td id="vComplainant">—</td></tr>

            <tr><th>Respondent</th><td id="vRespondent">—</td></tr>

            <tr><th>Location</th><td id="vLocation">—</td></tr>

            <tr><th>Case Date</th><td id="vIncidentDate">—</td></tr>

            <tr><th>Status</th><td id="vStatus"><span class="badge badge-secondary">—</span></td></tr>
        ...
        <div class="mb-3">
          ...
          <p id="vNarrative" class="small text-muted mb-0"></p>
        ...
        <div class="mb-3">
          ...
          <p id="vActionTaken" class="small text-muted mb-0"></p>
      ...
      <div class="modal-footer d-flex justify-content-between">
        ...
        <div>
          ...
          <button id="btnAdvanceStatus" class="btn btn-success" type="button" style="display:none;">

            <i class="fas fa-arrow-circle-right mr-1"></i> <span id="btnAdvanceLabel"></span>

          </button>

          <span id="statusClosedBadge" class="badge badge-secondary p-2" style="display:none;font-size:13px;">

            <i class="fas fa-lock mr-1"></i> Case Closed
        ...
        <div>
          ...
          <button id="btnViewPrint" class="btn btn-secondary btn-sm mr-1" type="button">
